...
public class VentaNuevo implements Initializable {

    private ArrayList<Cliente> clientes;
    private  ArrayList<ProductoCosto> ventaProductoCostos;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        try {
            ...
            while (resultSet.next()){
                ...
                clientes.add(new Cliente(resultSet.getInt("idClientes"),
        ...
        producto.setOnKeyTyped(event -> {
            ...
            if(patron.length()<3)
                ...
                try {
                    ...
                    ResultSet resultSet = statement.executeQuery(sql);
                    ventaProductoCostos = new ArrayList<ProductoCosto>();
                    listaProductos.getItems().clear();

                    while (resultSet.next()){
                        listaProductos.getItems().add(resultSet.getString("nombre"));

                        ventaProductoCostos.add(new ProductoCosto(resultSet.getInt("idProducto"),
        ...
        TableColumn<VentaElementos, String> columnaCantidad=
                new TableColumn<>("Cant");
        columnaCantidad.setMinWidth(15);
        columnaCantidad.setCellValueFactory(new PropertyValueFactory<>("cantidad"));

        TableColumn<VentaElementos, String> columnaNombre=
                new TableColumn<>("Nombre Producto");
        columnaNombre.setMinWidth(200);
        columnaNombre.setCellValueFactory(new PropertyValueFactory<>("nombre"));

        TableColumn<VentaElementos, String> columnaCostoU=
                new TableColumn<>("C. U");
        columnaCostoU.setMinWidth(15);
        columnaCostoU.setCellValueFactory(new PropertyValueFactory<>("costoU"));

        TableColumn<VentaElementos, String> columnaCostoT=
                new TableColumn<>("C. T");
        columnaCostoT.setMinWidth(15);
